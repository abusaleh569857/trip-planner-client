  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Show SweetAlert popup with total cost
        Swal.fire({
          title: "Total Price",
          text: `The total cost of your package is ${totalPrice} Taka. Confirm to book.`,
          icon: "info",
          ...
          if (result.isConfirmed) {
            // If confirmed, add booking to the database
            ...
            if (bookingResponse.status === 200) {
              Swal.fire("Success!", "Your package has been booked!", "success");
            }
          }
        });
      }
